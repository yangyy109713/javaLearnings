...
public class SeleniumDamai {
	public static void main(String args[]) throws InterruptedException{
		...
		//driver.findElement(By.xpath("//input[@id='login_pwd'][@type='password']")).sendKeys("y10203040000");//输入密码，定位方式二,XPath定位较耗性能
		Thread.sleep(500);
		...
		driver.findElement(By.xpath("//div[@class='z-show'][5]/div/dl/dd/ol/li[1]")).click();//点击“合肥”
		
		driver.findElement(By.xpath("//ul[@class='inp-hd']/li[3]")).click();//点击“蜀山区”
		driver.findElement(By.xpath("//div[@class='z-show'][5]/div/dl/dd/ol/li[1]")).click();//点击“蜀山区”
		
		driver.findElement(By.xpath("//div[@class='invoice-cnt'][3]/div[2]/div/textarea[1]")).sendKeys("合肥农业大学");//街道地区
